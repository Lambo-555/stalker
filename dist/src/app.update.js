...
let AppUpdate = (AppUpdate_1 = class AppUpdate {
  ...
  async onUse(ctx, next) {
    ...
    try {
      const messageId =
        (_b =
          (_a = ctx === null || ctx === void 0 ? void 0 : ctx.update) ===
            null || _a === void 0
            ? void 0
      ...
      const chatId =
        (_d =
          (_c = ctx === null || ctx === void 0 ? void 0 : ctx.update) ===
            null || _c === void 0
            ? void 0
      ...
      const menuMessage =
        (_f =
          (_e = ctx === null || ctx === void 0 ? void 0 : ctx.update) ===
            null || _e === void 0
            ? void 0
  ...
  async onDisplay(ctx) {
    try {
      ...
      ctx.scene.state[playerData.player.telegram_id] =
        await this.appService.updateStorePlayer(
          ctx,
          Object.assign(Object.assign({}, playerData.player), {
    ...
    try {
      ...
      keyboardButtons.push(
        telegraf_1.Markup.button.callback(
          '📍Перемещение',
          scenes_enum_1.ScenesEnum.SCENE_LOCATION,
        ),
      );
      keyboardButtons.push(
        telegraf_1.Markup.button.callback(
          '📟PDA',
          scenes_enum_1.ScenesEnum.SCENE_PDA,
        ),
      );
      keyboardButtons.push(
        telegraf_1.Markup.button.callback(
      ...
      this.appService.updateDisplay(
        playerData === null || playerData === void 0
          ? void 0
          : playerData.player,
        keyboard,
        this.appService.escapeText(
          `Вы на локации: ${
            (_a =
              playerData === null || playerData === void 0
                ? void 0
                : playerData.playerLocation) === null || _a === void 0
              ? void 0
              : _a.location
          }.`,
        ),
        (_b =
          playerData === null || playerData === void 0
            ? void 0
            : playerData.playerLocation) === null || _b === void 0
          ? void 0
          : _b.image,
      );
    } catch (error) {
