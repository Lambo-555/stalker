...
export declare class MutantScene {
    ...
    constructor(appService: AppService, usersRepository: Repository<Users>, chaptersRepository: Repository<Chapters>, choicesRepository: Repository<Choices>, progressRepository: Repository<Progress>, inventoryItemsRepository: Repository<InventoryItems>, mutantsRepository: Repository<Mutants>);
    onRegister(ctx: TelegrafContext, next: NextFunction): Promise<void>;
    onSceneEnter(ctx: TelegrafContext): Promise<void>;
    battle(enemy: Mutants, user: Users, text?: string): string;
