...
let BattleScene = BattleScene_1 = class BattleScene {
    constructor(appService) {
        this.appService = appService;
        this.logger = new common_1.Logger(BattleScene_1.name);
        this.navigationKeyboard = [
            telegraf_1.Markup.button.callback('↖️50m', 'moveXXX' + '↖️'),
            telegraf_1.Markup.button.callback('⬆️50m', 'moveXXX' + '⬆️'),
            telegraf_1.Markup.button.callback('↗️50m', 'moveXXX' + '↗️'),
            telegraf_1.Markup.button.callback('⬅️50m', 'moveXXX' + '⬅️'),
            telegraf_1.Markup.button.callback('⏹00m', '⏱'),
            telegraf_1.Markup.button.callback('➡️50m', 'moveXXX' + '➡️'),
            telegraf_1.Markup.button.callback('↙️50m', 'moveXXX' + '↙️'),
            telegraf_1.Markup.button.callback('⬇️50m', 'moveXXX' + '⬇️'),
            telegraf_1.Markup.button.callback('↘️50m', 'moveXXX' + '↘️'),
    ...
    calculateDamageForGun(gun, distance) {
        const damage = Math.floor((((gun.optimal_distance / (gun.optimal_distance + distance)) *
...
], BattleScene.prototype, "attackEnemy", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BattleScene.prototype, "onMove", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BattleScene.prototype, "onSceneEnter", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BattleScene.prototype, "onLeaveCommand", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BattleScene.prototype, "enterBanditScene", null);
BattleScene = BattleScene_1 = __decorate([
    (0, nestjs_telegraf_1.Scene)(scenes_enum_1.ScenesEnum.SCENE_BATTLE),
    __metadata("design:paramtypes", [app_service_1.AppService])
], BattleScene);
exports.BattleScene = BattleScene;
//# sourceMappingURL=battle.scene.js.map